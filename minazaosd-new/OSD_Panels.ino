...
void panHeading(int first_col, int first_line) {
    osd.setPanel(first_col, first_line);
    osd.openPanel();
    char* HeadingSource="g";
    if (osd_heading_source==1) HeadingSource="m";
    osd.printf("%4.0f%c%s", (double)osd_heading, 0xb0, HeadingSource);
    osd.closePanel();
}
...
#define	STEP_WIDTH	100			// every STEP_WIDTH in [m] it is down-scaled
